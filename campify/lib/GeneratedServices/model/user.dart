...
class User {
  ...
  @override
  String toString() => 'User[userId=$userId, name=$name, email=$email, phone=$phone, password=$password, preferences=$preferences, userType=$userType, createdAt=$createdAt]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (preferences != null) {
      _json[r'preferences'] = preferences;
    }
    if (userType != null) {
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        ...
        preferences: mapValueOfType<String>(json, r'preferences'),
